...
# Get files
wget -c https://github.com/wavesplatform/Waves/releases/download/v1.4.9/waves_1.4.9_all.deb
...
wget https://github.com/anotedigital/anote-node/releases/download/v1.2.4/anote-node

# Install Waves node
dpkg -i waves_1.4.9_all.deb
mkdir /var/lib/anote
